...
Overall, there were clear indications of change in water temperature over the study period during the winter season. Of particular interest, water temperature was increasing through time during winter for all systems except Cedar Key. There was no change in water temperature during summer. Simultaneously, bottom vegetation coverage (BVC) increased in Charlotte Harbor (both seasons) and Tampa Bay (winter only), but decreased during the summer in Cedar Key.

Summer temperatures were fairly stable over the 22-year period, with mean (+-se) change of 0.X C (0.Y) (Fig X). Although change in temperatures during winter months were not statistically significant for any of the systems, the magnitude was more pronounced than the summer months (mean +-se = 2.1 +- 0.9).

Temperature increased significantly through time for all estuaries in the winter and for Apalachicola Bay and Tampa Bay in the summer ([@fig-TempPlot]; [@tbl-tempModels]).
...
emphasize.strong.cells(which(tempPvalues < 0.05, arr.ind = TRUE))
pander(tempEstimates)
```
...
emphasize.strong.cells(which(bvcPvalues < 0.05, arr.ind = TRUE)) 
pander(bvcEstimates)
```
...
### Some Analyses {#sec-some-analyses}
