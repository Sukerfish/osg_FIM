...
#| label: tbl-abundSyn
#| echo: FALSE
#| tbl-cap: "Summary of observed biological response trends per system and season from total abundance model. Trend direction calculated using GLMM framework and significant at alpha 0.95."

sumTab <- data.frame(
  Parameter = c("Total abundance", "Total abundance", "Water temperature", "Water temperature", "SAV coverage", "SAV coverage"), 
  Effect = c("No change", "Decreasing", "N/A", "Positive ", "Positive", "Positive"), 
