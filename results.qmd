...
Before examining the relationship between temperature and richness/abundance, I used PERMANOVA to test for any significant interaction between estuary and year. Indeed, for both seasons, the interaction between year and estuary was significant ([@tbl-fullPERMANOVAwinter; @tbl-fullPERMANOVAsummer]). This confirmed the need to separately examine each estuary from here onward.
...
Total abundance was significantly affected by BVC in almost all estuaries, while the only case when temperature was significant was in Apalachicola Bay in the summer ([@tbl-abundModels]).
...
Similarly, total richness was significantly affected by BVC in almost all estuaries, while temperature was not significant in any estuaries during the summer ([@tbl-richModels]).
...
Overall, x species were changing. See [@tbl-sigTaxa]

```{r}
#| label: tbl-sigTaxa
#| echo: FALSE
#| message: FALSE
#| tbl-cap: "Changing taxa"
pander(sigSummary)
```

Then looking at the whole plot..
