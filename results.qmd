...
#| fig-width: 6.5 
#| fig-height: 6 
#| fig-cap: "Annually averaged SAV coverage over time. Error bars represent ± 1 standard error. Solid lines indicate significant modeled trends and dashed lines indicate a trend of no significance, per each independent linear model."
