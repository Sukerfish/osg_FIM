...
NMDS plots are cool (\[@fig-NMDS_winter\]).

```{r}
#| label: fig-NMDS_winter
#| echo: FALSE
#| message: FALSE
#| fig.width: 7.5
#| fig.heigh: 5
#| fig-cap: "NMDS amazing plot"
plot(winterNMDS)
```

And they're warm ([@fig-NMDS_summer]).

```{r}
#| label: fig-NMDS_summer
#| echo: FALSE
#| message: FALSE
#| fig.width: 7.5
#| fig.heigh: 5
#| fig-cap: "NMDS amazing summer plot"
plot(summerNMDS)
```
...
Next up... PERMANOVA! The best is this one [@tbl-fullPERMANOVAwinter].
