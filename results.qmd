...
#| fig-width: 6.5 
#| fig-height: 6 
#| fig-cap: "Submerged aquatic vegetation coverage as a percentage averaged annually and plotted over time. Error bars are ± 1 standard error. Solid lines indicate signficant modeled trends and dashed lines indicate a trend of no significance."
...
![Summary of observed habitat parameter trends per system and season. Trend direction calculated using ANCOVA framework and significant at alpha 0.95.](conceptFigs/habParamSyn.png){#fig-habParams}
...
Next, I used PERMANOVA to test for any significant interaction between estuary and year in species-space before proceeding with CAP models. Indeed, for both seasons, the interaction between year and estuary was significant and so separate CAP models were conducted for each ([@tbl-fullPERMANOVA]).
...
The majority of taxa that changed over time were either subtropical/tropical-associated or subtropical/tropical/temperate-associated.
