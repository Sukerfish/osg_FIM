...
winterSlope <- tidy(lstrends(winterLm, ~ system, var = "smallYear"))
summerSlope <- tidy(lstrends(summerLm, ~ system, var = "smallYear"))
...
#pairwise slope checks
BVCwinterSlope <- tidy(lstrends(winterBVCLm, ~ system, var = "smallYear"))
BVCsummerSlope <- tidy(lstrends(summerBVCLm, ~ system, var = "smallYear"))
```
