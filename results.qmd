...
However, total abundance over time was quite variable for all systems in the winter season, with summer generally rather stable (@fig-AbundPlot).
...
Seagrass coverage did stuff (@fig-BVCPlot).
...
Temperature was interesting (@fig-TempPlot).
